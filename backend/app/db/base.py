...
def str_enum(enum_cls: type[enum.Enum], name: str | None = None) -> Enum:
    """Store Python enums as VARCHAR + CHECK constraint (easier to migrate than PG enums)."""
    return Enum(
        enum_cls,
...
__all__ = ["Base", "Decimal", "Money", "SoftDeleteMixin", "TimestampMixin", "UUIDPkMixin", "str_enum"]
